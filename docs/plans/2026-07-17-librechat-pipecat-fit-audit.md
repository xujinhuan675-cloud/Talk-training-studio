...
| files / RAG / training materials | LibreChat | 55% | file asset ownership 与服务层 scope 已补强；training material 安全摘要、受控正文片段、复盘素材对照卡片和素材对照 LLM adapter 已接入。素材全文/RAG/persona builder 自动接入仍不进入当前切片。 |
