...
from api.routes import training_assist as training_assist_routes
...
app.include_router(training_assist_routes.router, prefix="/api/v1")
app.include_router(training_team_routes.router, prefix="/api/v1")
